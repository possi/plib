 ...
 */
package de.jaschastarke.bukkit.lib.locale;
...
import de.jaschastarke.minecraft.lib.locale.ILanguage;
import de.jaschastarke.utils.StringUtil;

public class PluginLang implements ILanguage {
    ...
    public PluginLang(Core plugin) {
        this(plugin, null);
    }
    
    public PluginLang(PluginCore plugin, String lang) {
        this.plugin = plugin;
        if (lang == null)
